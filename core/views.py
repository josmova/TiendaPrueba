        ...
        try:
            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    print("Usando la dirección de envío defualt")
                    ...
                    if address_qs.exists():
                        ...
                        messages.info(
                            self.request, "No hay dirección de envío por defecto disponible")
                        return redirect('core:checkout')
                else:
                    ...
                    if is_valid_form([shipping_address1, shipping_country, shipping_zip]):
                        ...
                        messages.info(
                            self.request, "Por favor, rellene los campos de dirección de envío requeridos")
                ...
                if same_billing_address:
                    ...
                    print("Usando la dirección de facturación predeterminada")
                    address_qs = Address.objects.filter(
                        user=self.request.user,
                        address_type='B',
                        default=True
                    ...
                    if is_valid_form([billing_address1, billing_country, billing_zip]):
                        ...
                        messages.info(
                            self.request, "Por favor, rellene los campos de dirección de facturación requeridos")
                ...
                if payment_option == 'S':
                    ...
                    messages.warning(
                        self.request, "Opción de pago no válida seleccionada")
                    return redirect('core:checkout')
        except ObjectDoesNotExist:
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.warning(self.request, "Error de límite de velocidad")
                return redirect("/")
                ...
                # yourself an email
                messages.warning(
                    self.request, "Algo salió mal. Inténtalo de nuevo.")
                return redirect("/")

            except Exception as e:
                # send an email to ourselves
                messages.warning(
                    self.request, "Ocurrió un grave error. Hemos sido notificados.")
                return redirect("/")

        messages.warning(self.request, "Datos inválidos recibidos")
...
def add_to_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        if order.items.filter(item__slug=item.slug).exists():
            ...
            order_item.save()
            messages.info(request, "Esta cantidad de artículo fue actualizada.")
            return redirect("core:order-summary")
        else:
            order.items.add(order_item)
            messages.info(request, "Este artículo ha sido añadido a tu carrito..")
            return redirect("core:order-summary")
    else:
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.info(self.request, "Tu solicitud fue recibida.")
                return redirect("core:request-refund")

            except ObjectDoesNotExist:
                messages.info(self.request, "Este orden no existe.")
                return redirect("core:request-refund")
